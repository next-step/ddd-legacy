...
class InputStringTest {
    ...
    fun `기본 구분자와 숫자`() {
        ...
        assertThat(InputString.of(testString).value).isEqualTo(testString)
    }
    ...
    fun `빈 문자열 또는 널`() {
        val emptySpace = ""
        assertThat(InputString.of(emptySpace).value).isEqualTo("0")

        val nullable = null
        assertThat(InputString.of(nullable).value).isEqualTo("0")
    }
