...
class CarTest {
    ...
    void testCarInstantiationSuccessWhenNameLengthIsLessThanOrEqualToFive(final String name) {
        // given when then
    ...
    void testCarInstantiationFailureWhenNameLengthIsGreaterThanFive() {
        // given
        final String name = "동해물과 백두산이";
