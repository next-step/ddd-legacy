...
public class DelimiterParserTest {
    ...
    void oneNumber(final String text){
        assertThat(delimiterParser.parseDelimiter(text)).containsExactly("1");
    }
    ...
    void twoNumbers(final String text){
        assertThat(delimiterParser.parseDelimiter(text)).containsExactly("1", "2");
    }
    ...
    void colons(final String text){
        assertThat(delimiterParser.parseDelimiter(text)).containsExactly("1", "2", "3");
    }
