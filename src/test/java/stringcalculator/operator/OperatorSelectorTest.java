...
import static stringcalculator.operator.OperatorSelector.*;
...
class OperatorSelectorTest {
    ...
    void defaultDelimiterTest(String given) {
        assertThat(selectOperator(given)).isEqualTo(new DefaultDelimiterOperator(given));
    }
    ...
    void customDelimiterTest(String given) {
        assertThat(selectOperator(given)).isEqualTo(new CustomDelimiterOperator(given));
    }
