...
class CarTest {
    ...
    void 자동차_생성_이름_길이_5글자_초과_실패_테스트() {
        assertThatThrownBy(() -> new Car("goJade", 0))
    ...
    void 자동차_이동_초기_숫자__음수_실패_테스트() {
        assertThatThrownBy(() -> new Car("goJad", -1))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void 숫자가_4이상_한칸_이동_테스트(int value) {
        ...
        assertThat(car.move(value, moveNumber -> true)).isEqualTo(new Car("goJad", 1));
    }
    ...
    void 숫자가_3이하_제자리_이동_테스트(int value) {
        ...
        assertThat(car.move(value, moveNumber -> false)).isEqualTo(new Car("goJad", 0));
    }
