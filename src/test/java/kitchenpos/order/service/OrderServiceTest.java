...
public class OrderServiceTest {
    ...
    class eatInTest {
        ...
        void serve() {
            ...
            mockingOrderRepository(RepositoryMethod.FIND, 매장_접수_주문);
            orderService.serve(매장_접수_주문.getId());
    ...
    class takeOutTest {
        ...
        void serve() {
            ...
            mockingOrderRepository(RepositoryMethod.FIND, 포장_접수_주문);
            orderService.serve(포장_접수_주문.getId());
