...
import static kitchenpos.order.accpetance.step.OrderStep.배달을_시작한다;
import static kitchenpos.order.accpetance.step.OrderStep.배달을_완료한다;
...
public class DeliveryOrderAcceptanceTest extends AcceptanceTest {
    ...
    void create() {
        ...
        var 등록할_주문 = 주문을_생성한다(주문_항목, "서울 서대문구");
    ...
    void findAll() {
        ...
        var 등록할_김치찜_1인_메뉴_1개_주문 = 주문을_생성한다(List.of(김치찜_1인_메뉴_1개_주문), "서울 은평구");
        var 등록할_봉골레_파스타_세트_메뉴_1개_주문 = 주문을_생성한다(List.of(봉골레_파스타_세트_메뉴_1개_주문), "서울 관악구");
    ...
    void delivering() {
        ...
        assertAll(
                () -> assertThat(주문_optional.isPresent()).isTrue(),
                () -> assertThat(주문_optional.get().getStatus()).isEqualTo(OrderStatus.DELIVERING)
        );
    }
    ...
    void delivered() {
        ...
        assertAll(
                () -> assertThat(주문_optional.isPresent()).isTrue(),
                () -> assertThat(주문_optional.get().getStatus()).isEqualTo(OrderStatus.DELIVERED)
        );
    }
    ...
    private Order 주문을_생성한다(List<OrderLineItem> orderLineItems, String deliveryAddress) {
        var 주문 = new Order();
