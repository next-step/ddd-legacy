...
public class ProductFixture {
    ...
    public static final Product H_제품 = 제품을_생성한다(UUID.randomUUID(), "H", 랜덤한_1000원이상_3000원이하의_금액을_생성한다());
    public static final Product I_제품 = 제품을_생성한다(UUID.randomUUID(), "I", 랜덤한_1000원이상_3000원이하의_금액을_생성한다());
    public static final Product uuid가_존재하는_가격이_마이너스인_제품 = 제품을_생성한다("G", 랜덤한_마이너스_1000원이하_금액을_생성한다());

    private static Product 제품을_생성한다(String name, BigDecimal price) {
        return 제품을_생성한다(null, name, price);
    }

    private static Product 제품을_생성한다(UUID id, String name, BigDecimal price) {
        var 제품 = new Product();
        제품.setId(id);
        제품.setName(name);
        제품.setPrice(price);
