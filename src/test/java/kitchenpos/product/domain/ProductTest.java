...
class ProductTest {
    ...
    void productPriceOverZero() {
        assertThatThrownBy(() -> new Product(UUID.randomUUID(), new Name("상품명", false), new Price(BigDecimal.valueOf(-1))))
    ...
    void requireProductPrice() {
        assertThatThrownBy(() -> new Product(UUID.randomUUID(), new Name("상품명", false), null))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void requireProductName() {
        assertThatThrownBy(() -> new Product(UUID.randomUUID(), null, new Price(BigDecimal.ONE)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    @Test
    void profanity() {
        assertThatThrownBy(() -> new Product(UUID.randomUUID(), new Name("상품명", true), new Price(BigDecimal.ONE)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void changeMinimumPrice() {
        Product product = new Product(UUID.randomUUID(), new Name("상품명", false), new Price(BigDecimal.ONE));
    ...
    @Test
    void createProduct() {
        assertThatNoException().isThrownBy(() -> new Product(UUID.randomUUID(), new Name("상품명", false), new Price(BigDecimal.ONE)));
    }
