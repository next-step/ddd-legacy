...
public class ProductStep {
    ...
    public static ExtractableResponse<Response> 상품을_등록한다(Product request) {
        return RestAssuredClient.post(PRODUCT_BASE_URL, request);
    }

    public static ExtractableResponse<Response> 상품_목록을_조회한다() {
        return RestAssuredClient.get(PRODUCT_BASE_URL);
    }

    public static ExtractableResponse<Response> 상품_가격을_수정한다(Product request) {
