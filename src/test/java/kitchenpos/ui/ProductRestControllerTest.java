...
class ProductRestControllerTest {
    ...
    void create() throws Exception {
        var request = ProductFixture.createProduct("테스트", 1000L);
        var response = ProductFixture.copy(request);
    ...
    void changePrice() throws Exception {
        ...
        var response = ProductFixture.createProduct(productId, "테스트", 1000L);
    ...
    void findAll() throws Exception {
        var response = List.of(
                ProductFixture.createProduct("테스트1", 1000L),
                ProductFixture.createProduct("테스트2", 2000L)
        );
