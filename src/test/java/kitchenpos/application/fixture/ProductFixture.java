...
public record ProductFixture(UUID id, String 상품명, BigDecimal 상품가격) {
    ...
    public static final String DEFAULT_PRODUCT_PRICE = "20000";

    public static ProductFixture init() {
        return new ProductFixture(UUID.randomUUID(), DEFAULT_PRODUCT_NAME,
            new BigDecimal(DEFAULT_PRODUCT_PRICE));
    }
    ...
    public static ProductFixture test(String 상품명, BigDecimal 상품가격) {
        return new ProductFixture(
            ...
            Objects.requireNonNullElse(상품가격, new BigDecimal(DEFAULT_PRODUCT_PRICE))
        );
    }
