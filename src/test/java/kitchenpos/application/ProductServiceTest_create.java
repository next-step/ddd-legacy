...
@EnableTestGlue
@SpringBootTest
class ProductServiceTest_create extends TestIsolationSupport {
	...
	void create() {
		testGlue.builder()
			.given("'정상상품' 상품 데이터를 생성하고")
			.when("'정상상품' 상품 생성을 요청하면")
			.then("'정상상품' 상품이 생성된다")
			.assertStart();
	}
	...
	void create_emtpyPrice() {
		testGlue.builder()
			.given("'가격이 빈 상품' 상품 데이터를 생성하고")
			.when("'가격이 빈 상품' 상품 생성을 요청하면")
			.then("'가격이 빈 상품' 상품이 생성에 실패한다")
			.assertStart();
	}
	...
	void create_negativePrice() {
		testGlue.builder()
			.given("'가격이 음수인 상품' 상품 데이터를 생성하고")
			.when("'가격이 음수인 상품' 상품 생성을 요청하면")
			.then("'가격이 음수인 상품' 상품이 생성에 실패한다")
			.assertStart();
	}
}
