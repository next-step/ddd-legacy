...
class ProductServiceTest {
    ...
    @ParameterizedTest
    @DisplayName("등록 - 상품의 이름은 비속어가 될 수 없다")
    ...
    @Test
    @DisplayName("등록 - 상품의 가격은 0원 이상이어야 한다")
    ...
    @ParameterizedTest
    @DisplayName("등록 - 상품의 이름은 null 이면 예외가 발생한다")
    @NullSource
    ...
    @ParameterizedTest
    @DisplayName("등록 - 상품의 가격은 null 이면 예외가 발생한다")
    @NullSource
    ...
    @ParameterizedTest
    @DisplayName("수정 - 변경하려는 상품의 가격이 null 이면 예외가 발생한다")
    @NullSource
    ...
    @ParameterizedTest
    @DisplayName("수정 - 변경하려는 상품의 가격이 0보다 작으면 예외가 발생한다")
    ...
    @Test
    @DisplayName("수정 - 메뉴의 가격이 메뉴에 등록되어 있는 상품의 합(가격 * 수량)보다 크다면 메뉴는 전시되지 않는다")
