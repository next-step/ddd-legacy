...
class OrderServiceMockTest {
    ...
    class CreateTest {
        ...
        @DisplayName("DELIVERY 주문 생성을 성공한다")
        @Test
        ...
        @DisplayName("EAT_IN 주문 생성을 성공한다")
        @Test
        void create_eat_in() {
            // given
            Menu menu = 메뉴_생성(UUID.randomUUID(), true, BigDecimal.valueOf(10_000));
        ...
        @DisplayName("TAKEOUT 주문 생성을 성공한다")
        @Test
        void create_takeout() {
            // given
            Menu menu = 메뉴_생성(UUID.randomUUID(), true, BigDecimal.valueOf(10_000));
