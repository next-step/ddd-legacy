...
class OrderServiceTest {
	...
	void testCreateOrderWithNullType() {
		// given
	...
	void testCreateOrderWithNullOrEmptyLineItems(List<OrderLineItem> lineItems) {
		// given
	...
	void testCreateOrderWithMismatchedMenusAndRequests() {
		// given
	...
	void testCreateOrderWithNonExistentMenu() {
		// given
	...
	void testCreateOrderWithHiddenMenu() {
		// given
	...
	void testCreateOrderWithMismatchedPrice() {
		// given
	...
	void testCreateDeliveryOrderWithNullOrEmptyAddress(String address) {
		// given
	...
	void testCreateEatInOrderWithNonExistentTable() {
		// given
		validOrder.setType(OrderType.EAT_IN);
	...
	void testCreateEatInOrderWithNonOccupiedTable() {
		// given
		validOrder.setType(OrderType.EAT_IN);
	...
	void testCreateEatInOrderSuccessfully() {
		// given
		validOrder.setType(OrderType.EAT_IN);
		validOrderTable.setOccupied(true);
	...
	void testAcceptNonExistentOrder() {
		// given
	...
	void testAcceptNonWaitingOrder() {
		// given
		UUID orderId = UUID.randomUUID();
	...
	void testServeNonExistentOrder() {
		// given
		UUID orderId = UUID.randomUUID();
		when(orderRepository.findById(orderId)).thenReturn(Optional.empty());
	...
	void testServeNonAcceptedOrder() {
		// given
		UUID orderId = UUID.randomUUID();
		validOrder.setStatus(OrderStatus.WAITING);
		when(orderRepository.findById(orderId)).thenReturn(Optional.of(validOrder));
	...
	void testStartDeliveryNonExistentOrder() {
		// given
		UUID orderId = UUID.randomUUID();
		when(orderRepository.findById(orderId)).thenReturn(Optional.empty());
	...
	void testStartDeliveryOnNonDeliveryOrder(OrderType orderType) {
		// given
		UUID orderId = UUID.randomUUID();
	...
	void testStartDeliveryNotServedOrder(OrderStatus nonServedStatus) {
		// given
		UUID orderId = UUID.randomUUID();
		validOrder.setType(OrderType.DELIVERY);
	...
	void testStartDeliveryServedOrder() {
		// given
		UUID orderId = UUID.randomUUID();
		validOrder.setType(OrderType.DELIVERY);
		validOrder.setStatus(OrderStatus.SERVED);
	...
	void testCompleteDeliveryNonExistentOrder() {
		// given
		UUID orderId = UUID.randomUUID();
		when(orderRepository.findById(orderId)).thenReturn(Optional.empty());
	...
	void testCompleteDeliveryNotDeliveringOrder(OrderStatus orderStatus) {
		// given
		UUID orderId = UUID.randomUUID();
	...
	void testCompleteDeliveryDeliveringOrder() {
		// given
		UUID orderId = UUID.randomUUID();
	...
	void testCompleteNonDeliveredOrder() {
		// given
		UUID orderId = UUID.randomUUID();
		validOrder.setType(OrderType.DELIVERY);
		validOrder.setStatus(OrderStatus.DELIVERING);
	...
	void testCompleteDeliveredOrder() {
		// given
		UUID orderId = UUID.randomUUID();
		validOrder.setType(OrderType.DELIVERY);
	...
	void testOrderCompletionExceptions(OrderType type, OrderStatus status) {
		// given
		UUID orderId = UUID.randomUUID();
	...
	void testCompleteServedTakeoutOrder() {
		// given
		UUID orderId = UUID.randomUUID();
	...
	void testCompleteServedEatInOrderWithActiveTable() {
		// given
		UUID orderId = UUID.randomUUID();
		validOrder.setType(OrderType.EAT_IN);
		validOrder.setStatus(OrderStatus.SERVED);
		when(orderRepository.findById(orderId)).thenReturn(Optional.of(validOrder));
		when(orderRepository.existsByOrderTableAndStatusNot(validOrderTable, OrderStatus.COMPLETED)).thenReturn(true);
	...
	void testCompleteServedEatInOrderWithNoActiveTable() {
		// given
		UUID orderId = UUID.randomUUID();
		validOrder.setType(OrderType.EAT_IN);
		validOrder.setStatus(OrderStatus.SERVED);
		...
		when(orderRepository.findById(orderId)).thenReturn(Optional.of(validOrder));
		when(orderRepository.existsByOrderTableAndStatusNot(validOrderTable, OrderStatus.COMPLETED)).thenReturn(false);
	...
	@Test
	@DisplayName("모든 주문 조회 시 정상적으로 주문 목록이 반환된다")
