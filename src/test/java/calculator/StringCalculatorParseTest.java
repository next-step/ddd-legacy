...
class StringCalculatorParseTest {
    ...
    void emptyOrNull(final String text) {
        assertThat(parser.toPositiveNumbers(text).sum())
    ...
    void negative() {
        assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(() -> parser.toPositiveNumbers("-1"));
    }
    ...
    void nonNumberTest() {
        assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(() -> parser.toPositiveNumbers("a:b:c"));
    }
}
