...
class StringParserTest {
    ...
    void defaultSeparator(String input, List<Integer> result) {
    ...
    static Stream<Arguments> defaultSeparatorArgs() {
        return Stream.of(
            ...
            Arguments.of("1,2,4", Arrays.asList(1,2,4))
        );
    }
    ...
    void customSeparator(String input, List<Integer> result) {
        assertThat(this.stringParser.split(input)).containsAll(result);
    }

    static Stream<Arguments> customSeparatorArgs() {
        return Stream.of(
            Arguments.of("//a\n0a0a1", Arrays.asList(0,0,1)),
            Arguments.of("//a\n1a2a3", Arrays.asList(1,2,3)),
            Arguments.of("//b\n1b2b4", Arrays.asList(1,2,4))
        );
    }
