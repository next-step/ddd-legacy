...
public class StringCalculatorTest {
	...
	void nullOrEmptyReturnZero() {
		assertAll(() -> assertThat(stringCalculator.calculate("")).isEqualTo(0),
	...
	void oneNumberReturnNumber() {
		assertAll(() -> assertThat(stringCalculator.calculate("1")).isEqualTo(1),
	...
	void negativeNumberThrowException() {
		assertThatCode(() -> stringCalculator.calculate("1,-2,3")).isInstanceOf(IllegalArgumentException.class)
	...
	void onlyNumberCanBeInput() {
		assertThatCode(() -> stringCalculator.calculate("1,*,3")).isInstanceOf(IllegalArgumentException.class)
