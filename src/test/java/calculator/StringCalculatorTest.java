...
class StringCalculatorTest {
    ...
    void emptyOrNull(final String text) {
        ...
        assertThat(calculator.calculate(text)).isEqualTo(PositiveInt.zero());
    }

    /**
     * isEqualTo(): 캐싱된 객체가 아니면 false 를 반환
    ...
    void oneNumber(final String text) {
        assertThat(calculator.calculate(text)).isEqualTo(new PositiveInt((text)));
    }
    ...
    void twoNumbers(final String text, final int expected) {
        assertThat(calculator.calculate(text)).isEqualTo(new PositiveInt(expected));
    }
