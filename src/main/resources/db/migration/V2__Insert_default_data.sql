insert into product (id, carName, price)
...
insert into menu_group (id, carName)
...
insert into menu (id, displayed, carName, price, menu_group_id)
...
insert into order_table (id, occupied, carName, number_of_guests)
