...
### 1. 메뉴(menu) 요구 사항
    ...
    - [] : 메뉴는 등록할 수 있다.
    - [] : 메뉴를 등록할 때, 메뉴 그룹에게 <메뉴 검증>을 요청한다.
...
### 4. 주문(order) 요구 사항
    ...
    - [] : 주문이 정상적인지 확인하기 위해 <주문 검증>을 요청해야 한다.
...
| 한글명   | 영문명              | 설명                                               |
|-------|------------------|--------------------------------------------------|
| 메뉴 검증 | menu validation  | 메뉴의 상품들과 메뉴 그룹의 구성이 동일하게 존재하는지 확인한다.             |
| 주문 검증 | order validation | 주문 내역 의 구성이 주문한 메뉴들의 수량, 가격 구성과 동일하게 존재하는지 확인한다. |
