...
- 메뉴 그룹(Menu Group)
    - 새로운 메뉴 그룹을 추가할 수 있다.
        - [ ] 중복되는 id 의 메뉴 그룹은 추가할 수 없다.
        - [ ] 비어있는 name 의 메뉴 그룹은 추가할 수 없다.
    - 메뉴 그룹의 목록을 조회할 수 있다.
        - [ ] 추가된 메뉴 그룹은, 목록을 조회할 때 보여야 한다.
- 메뉴(Menu)
    - 새로운 메뉴를 추가할 수 있다.
        - [ ] 중복되는 id 의 메뉴는 추가할 수 없다.
        - [ ] 메뉴의 가격은 음수이거나 null값이 될 수 없다.
        - [ ] 기존에 존재하는 메뉴 그룹에 메뉴가 속해야한다.
        - [ ] 메뉴를 구성하는 product는 비어있거나 null 일 수 없다.
...
- 상품(Product)
    - 새로운 상품을 추가할 수 있다.
        - [ ] 중복되는 id 의 상품은 추가할 수 없다.
        - [ ] 상품의 가격은 null 이거나 음수일 수 없다.
        - [ ] 상품의 이름은 null 이거나 저속해서는 안된다.
    - 상품의 가격을 수정할 수 있다.
        - [ ] 상품의 가격은 null 이거나 음수일 수 없다.
        - [ ] 이미 추가된 상품만 수정할 수 있다.
        - [ ] 상품 가격 수정으로 인해, 상품의 합한 값보다 더 비싸진 메뉴가 있다면, 메뉴의 displayed 가 false 가 되어야 한다.
    - 상품들의 목록을 조회할 수 있다.
